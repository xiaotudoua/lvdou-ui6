...
import com.lvdoui6.android.tv.bean.Epg;
import com.lvdoui6.android.tv.bean.Group;
import com.lvdoui6.android.tv.bean.Keep;
import com.lvdoui6.android.tv.bean.Live;
import com.lvdoui6.android.tv.bean.Track;
import com.lvdoui6.android.tv.databinding.ActivityLiveBinding;
...
import com.lvdoui6.android.tv.impl.LiveCallback;
import com.lvdoui6.android.tv.impl.PassCallback;
...
import com.lvdoui6.android.tv.model.LiveViewModel;
...
import com.lvdoui6.android.tv.ui.custom.CustomKeyDownLive;
import com.lvdoui6.android.tv.ui.custom.CustomLiveListView;
import com.lvdoui6.android.tv.ui.dialog.LiveDialog;
import com.lvdoui6.android.tv.ui.dialog.LoginDialog;
import com.lvdoui6.android.tv.ui.dialog.MallDialog;
import com.lvdoui6.android.tv.ui.dialog.PassDialog;
import com.lvdoui6.android.tv.ui.dialog.SubtitleDialog;
import com.lvdoui6.android.tv.ui.dialog.TrackDialog;
import com.lvdoui6.android.tv.ui.presenter.ChannelPresenter;
import com.lvdoui6.android.tv.ui.presenter.GroupPresenter;
import com.lvdoui6.android.tv.utils.Biometric;
...
public class LiveActivity extends BaseActivity implements Clock.Callback, GroupPresenter.OnClickListener, ChannelPresenter.OnClickListener, CustomKeyDownLive.Listener, CustomLiveListView.Callback, TrackDialog.Listener, Biometric.Callback, PassCallback, LiveCallback, SubtitleCallback, MallCallback {
    ...
    protected void initView() {
        mClock = Clock.create(Arrays.asList(mBinding.widget.time, mBinding.display.time, mBinding.control.time));
    ...
    public void switchPlaybackStatus(boolean play) {
        if (play) {
            mPlayers.play();
            mClock.start();
        } else {
                ...
                if (admUser == null || admUser.getCode() != 1 || admUser.getData() == null || admUser.getData().getUserinfo() == null) {
                    ...
                    if (userInfo != null) {
                        ...
                        if (userInfo.getVip() > 0) {
                            if (!mPlayers.isPlaying()) switchPlaybackStatus(true);
                            setVip(true);
                            return;
                        }
                    }
    ...
    protected void onDestroy() {
        ...
        mPlayers.release();
        Source.get().stop();
        App.removeCallbacks(mR0, mR1, mR3, mR3, mR4, mR5);
    }
}
