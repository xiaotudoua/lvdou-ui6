...
import com.lvdoui6.android.tv.databinding.ActivitySettingCustomBinding;
...
import com.lvdoui6.android.tv.ui.dialog.ButtonsDialog;
import com.lvdoui6.android.tv.ui.dialog.DisplayDialog;
import com.lvdoui6.android.tv.ui.dialog.LanguageDialog;
import com.lvdoui6.android.tv.ui.dialog.MenuKeyDialog;
import com.lvdoui6.android.tv.ui.dialog.X5WebViewDialog;
...
//        mBinding.homeTagText.setText(getSwitch(Setting.isShowTag()));
        ...
        if (Hawk.get(HawkConfig.APP_E, "false").equals("false")) {
            mBinding.homeUI.setVisibility(View.GONE);
        }
    }
...
//        mBinding.homeTag.setOnClickListener(this::setShowTag);
...
//            mBinding.homeHistoryText.setText(getSwitch(Setting.isHomeHistory()));
            ...
            Setting.putHomeHistory(false);
//            mBinding.homeHistoryText.setText(getSwitch(Setting.isHomeHistory()));
        }
        new MaterialAlertDialogBuilder(this).setTitle(R.string.dialog_restart_app)
                .setMessage(R.string.dialog_restart_app_tip)
                .setNegativeButton(R.string.dialog_negative, null)
                .setPositiveButton(R.string.dialog_positive, (dialog, which) -> restartApp()).show();
    }

//    private void setShowTag(View view) {
//        Setting.putShowTag(!Setting.isShowTag());
//        mBinding.homeTagText.setText(getSwitch(Setting.isShowTag()));
//        new MaterialAlertDialogBuilder(this).setTitle(R.string.dialog_restart_app)
//                .setMessage(R.string.dialog_restart_app_tip)
//                .setNegativeButton(R.string.dialog_negative, null)
