...
import com.lvdoui6.android.tv.databinding.ActivitySettingBinding;
...
import com.lvdoui6.android.tv.ui.dialog.ConfigDialog;
...
public class SettingActivity extends BaseActivity implements ConfigCallback, SiteCallback, LiveCallback, DohCallback, ProxyCallback {
    ...
    protected void initView() {
        mBinding.vodHistory.requestFocus();
        ...
        mBinding.vod.setVisibility(customDepot ? View.VISIBLE : View.GONE);
        mBinding.live.setVisibility(customDepot ? View.VISIBLE : View.GONE);
        mBinding.wall.setVisibility(customDepot ? View.VISIBLE : View.GONE);
        setCacheText();
    }
    ...
    protected void initEvent() {
        ...
        mBinding.wallRefresh.setOnLongClickListener(this::WallRefresh);
        mBinding.custom.setOnClickListener(this::onCustom);
        mBinding.doh.setOnClickListener(this::setDoh);
        mBinding.about.setOnClickListener(this::onAbout);
    }

    private boolean WallRefresh(View view) {
        Hawk.put(HawkConfig.APP_H, !Hawk.get(HawkConfig.APP_H, false));
        Notify.show(Hawk.get(HawkConfig.APP_H, false) ? "已开启自动背景" : "已关闭自动背景");
        return true;
    }
