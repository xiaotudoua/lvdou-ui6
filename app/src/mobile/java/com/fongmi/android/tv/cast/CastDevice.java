package com.lvdoui6.android.tv.cast;
...
public class CastDevice {
    ...
    public List<com.lvdoui6.android.tv.bean.Device> getAll() {
        List<com.lvdoui6.android.tv.bean.Device> items = new ArrayList<>();
        for (org.fourthline.cling.model.meta.Device<?, ?, ?> item : devices) items.add(create(item));
        return items;
    }

    public List<com.lvdoui6.android.tv.bean.Device> add(org.fourthline.cling.model.meta.Device<?, ?, ?> item) {
        devices.remove(item);
        devices.add(item);
        return getAll();
    }
    ...
    public org.fourthline.cling.model.meta.Device<?, ?, ?> find(com.lvdoui6.android.tv.bean.Device item) {
