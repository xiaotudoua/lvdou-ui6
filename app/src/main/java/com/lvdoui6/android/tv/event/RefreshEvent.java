package com.lvdoui6.android.tv.event;
...
public class RefreshEvent {
    ...
    public static void homeCover(String path) {
        EventBus.getDefault().post(new RefreshEvent(Type.VODINFO, path));
    }

    public static void homeInfo(String path) {
        EventBus.getDefault().post(new RefreshEvent(Type.HOMEINFO, path));
    }
    ...
    public enum Type {
        CONFIG, IMAGE, VIDEO, HISTORY, KEEP, SIZE, WALL, DETAIL, PLAYER, SUBTITLE, DANMAKU, VODINFO, HOMEINFO
    }
}
