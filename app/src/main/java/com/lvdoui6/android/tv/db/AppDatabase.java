...
import com.lvdoui6.android.tv.bean.Device;
...
import com.lvdoui6.android.tv.db.dao.ConfigDao;
import com.lvdoui6.android.tv.db.dao.DeviceDao;
import com.lvdoui6.android.tv.db.dao.HistoryDao;
import com.lvdoui6.android.tv.db.dao.KeepDao;
import com.lvdoui6.android.tv.db.dao.LiveDao;
import com.lvdoui6.android.tv.db.dao.SiteDao;
import com.lvdoui6.android.tv.db.dao.TrackDao;
...
public abstract class AppDatabase extends RoomDatabase {
    ...
    public static void backup() {
        if (Setting.isBackupAuto()) backup(new com.lvdoui6.android.tv.impl.Callback());
    }

    public static void backup(com.lvdoui6.android.tv.impl.Callback callback) {
        App.execute(() -> {
    ...
    public static void restore(com.lvdoui6.android.tv.impl.Callback callback) {
        App.execute(() -> {
