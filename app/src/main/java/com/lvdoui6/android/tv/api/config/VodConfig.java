package com.lvdoui6.android.tv.api.config;
...
import com.lvdoui6.android.tv.api.Decoder;
import com.lvdoui6.android.tv.api.loader.JarLoader;
import com.lvdoui6.android.tv.api.loader.JsLoader;
import com.lvdoui6.android.tv.api.loader.PyLoader;
...
import com.lvdoui6.android.tv.bean.Rule;
...
public class VodConfig {
    ...
    private void initOther(JsonObject object) {
        ...
        setWall(Utils.getAdminUrl(Hawk.get(HawkConfig.API_BACKGROUND, Json.safeString(object, "wallpaper"))));
    }
    ...
    private void setWall(String wall) {
        ...
        if (HawkConfig.wallAuto()) WallConfig.get().load(new Callback());
    }
}
